...
import { faArrowRight, faPhone, faPhoneSlash, faVideo, faVideoSlash, faMicrophone, faMicrophoneSlash, faDesktop, faSatellite, faSatelliteDish, faMobileAlt, faComments, faWifi, faPaperPlane, faBroadcastTower, faMicrophoneAlt, faHeadphones, faVolumeUp, faGlobeAmericas, faUser, faTabletAlt } from "@fortawesome/free-solid-svg-icons"
  ...
  render() {
    return (
      <div className="App" style={{ height: window.innerHeight, flexDirection: (window.innerWidth > window.innerHeight) ? "row" : "column" }}>
        <div id="background">
          <svg className="waves" viewBox="0 0 1440 120" preserveAspectRatio="none" fill="#242933" style={{ backgroundColor: "#2E3440" }}>
          ...
          <div style={{ backgroundColor: "#242933", width: "100%", height: "50%" }} />
          <svg className="waves" viewBox="0 0 1920 157.327" preserveAspectRatio="none" fill="#2E3440" style={{ backgroundColor: "#242933" }}>
          ...
          <IconPattern
            icons={[faSatellite, faSatelliteDish, faMobileAlt, faComments, faPhone, faWifi, faPaperPlane, faBroadcastTower, faMicrophoneAlt, faHeadphones, faVideo, faVolumeUp, faGlobeAmericas, faUser, faDesktop, faTabletAlt]}
            num={5}
            margin={50}
            samples={20}
            color={"#2E3440"}
            ...
            {!this.state.username ? <div>
              ...
              !this.state.id ? <Spinner /> :
                <div>
                  ...
                  <span className="clickable-text" onClick={(event) => { navigator.clipboard.writeText(event.target.textContent) }}>{this.state.id}</span>
                  <br /><br /><br />
                  <ActionInput placeholder="Enter peer's ID" icon={faPhone} autoFocus={true} action={this.call} />
                </div>
            }
          </div>
        }
