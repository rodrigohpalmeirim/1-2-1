...
export default class VideocallApp extends Component {
  constructor(props) {
    super(props);
  ...
  call(id) {
    const mediaConnection = this.props.peer.call(id, mediaStream, { metadata: { id: this.props.id, username: this.state.username } });
  ...
  startCapture(displayMediaOptions) {
    ...
    navigator.mediaDevices.getDisplayMedia(displayMediaOptions)
      .then(stream => {
        ...
        for (const id in activeConnections)
          captureConnection = this.props.peer.call(id, stream, { metadata: { id: this.props.id, username: this.state.username + "'s screenshare" } });
  ...
  render() {
    return (
      <div className="App" style={{ height: window.innerHeight, flexDirection: (window.innerWidth > window.innerHeight) ? "row" : "column" }}>
        ...
        {!this.state.call && (
          !this.state.username ? <div id="panel">
            ...
            <ConnectionPannel id={this.props.id} icon={faPhone} action={this.call} />
        )}
